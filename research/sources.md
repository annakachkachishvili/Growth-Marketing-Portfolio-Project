...
**Curated by:** Anna Kachkachishvili
**Last verified:** 2026-06-11

A hand-picked list of **10 practitioners** in AI-powered SEO content — people who *actually do the work* (run agencies, build tools, or lead in-house content), not just write about it. Selection prioritized: (1) genuine practitioner proof, (2) close alignment to AI-powered SEO *content production*, and (3) **collectability via LinkedIn or YouTube** (the two channels this project collects from). Every source below has a verified, active official **LinkedIn or YouTube** link.

All three archetypes from the brief are represented — LinkedIn authors, YouTube creators, and podcast hosts. Full selection methodology and the candidates considered and cut are in the project decision log.

---

## Summary

| # | Name | Role / Company | **Collect from** | Verified link |
|---|------|----------------|------------------|---------------|
...
## 1. Jake Ward — *collect from LinkedIn*
- **Role:** Co-founder of Byword (AI content tool); runs an SEO agency.
- **LinkedIn:** https://www.linkedin.com/in/jakezward/ (~178K followers, posts regularly)
- **Why chosen:** The leading public voice on **programmatic SEO + AI content at scale**. Posts live experiments ("13,000+ programmatic pages in 3 hours") backed by real dashboards and revenue screenshots — the "show your work" practitioner the brief asks for.

## 2. Jesse Cunningham — *collect from YouTube*
- **Role:** Founder of a full-service SEO agency; teaches AI-powered content systems.
...
- **LinkedIn:** https://www.linkedin.com/in/lily-ray-44755615 · **YouTube:** https://www.youtube.com/@lilyray
- **Why chosen:** The **quality / E-E-A-T** authority — the "is this genuinely good, or AI-generated garbage?" lens 100Hires explicitly fears getting wrong. Essential counterweight to the production-at-scale voices.
...
*Dates of each specific collected post/video are recorded alongside the material in `/research/linkedin-posts/` and `/research/youtube-transcripts/` as collection proceeds.*
